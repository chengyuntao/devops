...
import com.quxie.store.mapper.ProductMapper;
import com.quxie.store.service.IProductService;
import com.quxie.store.service.ex.ProductNotFoundException;
...
public class ProductServiceImpl implements IProductService {
    ...
    public List<Product> findByParentId(Integer parentId) {
        List<Product> list = productMapper.findByParentId(parentId);
        for (Product product : list) {
            product.setPriority(null);
            product.setCreatedUser(null);
            product.setCreatedTime(null);
