...
import com.quxie.store.mapper.CartMapper;
...
import com.quxie.store.service.ex.CartNotFoundException;
...
public class CartServiceImpl implements ICartService {
    ...
    @Override
    public boolean deleteCartByCid(Integer cid) {
        if(this.cartMapper.deleteByCid(cid) < 1) {
            throw new CartNotFoundException("没找到对应的购物车数据");
        }
        return true;
    }
}
