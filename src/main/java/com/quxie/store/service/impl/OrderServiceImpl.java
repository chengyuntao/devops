...
import com.quxie.store.entity.Address;
import com.quxie.store.entity.Order;
import com.quxie.store.entity.OrderItem;
import com.quxie.store.mapper.OrderMapper;
import com.quxie.store.service.IAddressService;
import com.quxie.store.service.ICartService;
import com.quxie.store.service.IOrderService;
import com.quxie.store.service.ex.InsertException;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public List<Order> findAllOrders(Integer uid) {
        return new ArrayList<>(orderMapper.findAllOrder(uid));
    }

    @Override
    public List<OrderItem> findAllOrderItems(Integer oid) {
        return new ArrayList<>(orderMapper.findAllOrderItem(oid));
    }
}
